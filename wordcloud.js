class WordCloudData {
    ...
    populateWordsToCounts(inputString) {
        ...
        for (let char of words) {
            ...
            if (this.wordsToCounts[char]) {
                let newCount = this.wordsToCounts.get(char) + 1;
                this.wordsToCounts.set(char, newCount);
            } else {
                this.wordsToCounts.set(char, 1)
            }
        }

        // return this.wordsToCounts
        // const result = Object.entries(this.wordsToCounts);
